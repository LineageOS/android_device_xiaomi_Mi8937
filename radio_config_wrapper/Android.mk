...
_backend_hidl_package_name  := _mi8937.hardware.radio.oldcfg
_frontend_hidl_interface_name   := IRadioConfig
_backend_hidl_interface_name    := IRadioOldcfg

include $(CLEAR_VARS)
_version := 1.0
_sed_pattern := "s|$(_frontend_hidl_package_name)@$(_version)::$(_frontend_hidl_interface_name)|$(_backend_hidl_package_name)@$(_version)::$(_backend_hidl_interface_name)|g"
...
LOCAL_POST_INSTALL_CMD := /usr/bin/sed -i $(_sed_pattern) $(LOCAL_MODULE_PATH)/$(LOCAL_MODULE)
