...
Return<void> RadioConfig::setResponseFunctions(
    ...
    return mRadioOldcfg->setResponseFunctions(
            reinterpret_cast<
                    const sp<::_mi8937::hardware::radio::oldcfg::V1_0::IRadioOldcfgResponse>&>(
                    mRadioConfigResponse),
            reinterpret_cast<
                    const sp<::_mi8937::hardware::radio::oldcfg::V1_0::IRadioOldcfgIndication>&>(
...
Return<void> RadioConfig::getPhoneCapability(int32_t serial) {
    ...
    PhoneCapability phoneCapability = {}; // TODO
...
Return<void> RadioConfig::setPreferredDataModem(int32_t serial, uint8_t modemId) {
    ...
    switch (modemId) {
        case 0: // FIXME?
            mRadioSlot2->setDataAllowed(-1, false);
            mRadioSlot1->setDataAllowed(-1, true);
            break;
        case 1:
            mRadioSlot1->setDataAllowed(-1, false);
            mRadioSlot2->setDataAllowed(-1, true);
            break;
        default:
